...
class GameListAdapter extends DynamicFlowAdapter<GameSpecialPageState> {
  GameListAdapter()
      : super(
...
class _GameListAdapterConnector
    extends ConnOp<GameSpecialPageState, List<ItemBean>> {
  @override
  List<ItemBean> get(GameSpecialPageState state) {
  ...
  @override
  void set(GameSpecialPageState state, List<ItemBean> items) {}
