...
enum TrimMode { Length, Line, LineNew }
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget _buildGestureDetector(BuildContext context,
      TextStyle effectiveTextStyle, Color colorClickableText) {
...
//        _buildGestureDetector(context, effectiveTextStyle, colorClickableText);
