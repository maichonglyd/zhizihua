...
class DealPropPayDialog extends StatefulWidget {
  Goods dealGoods;
  ...
  DealPropPayDialog(
      this.dealGoods, this.roleName, this.serverName, this.select);
...
class DealPayState extends State<DealPropPayDialog> {
  Goods dealGoods;
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              buildInfoView(getText(name: 'textGetPropsColon'), dealGoods.title),
              buildInfoView(getText(name: 'textRoleNameDetail'), widget.roleName),
              buildInfoView(getText(name: 'textBelongServiceColon'), widget.serverName),
