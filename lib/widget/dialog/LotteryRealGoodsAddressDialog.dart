...
class LotteryRealGoodsAddressDialog extends StatefulWidget {
  String goodsId;

  LotteryRealGoodsAddressDialog(this.goodsId);
...
class DialogContentState extends State<LotteryRealGoodsAddressDialog> {
  String goodsId;
