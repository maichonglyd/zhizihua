...
class ExchangeSuccessDialog extends StatefulWidget {
...
class DialogContentState extends State<ExchangeSuccessDialog> {
  DialogContentState();
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new Container(
                  ...
                  child: Text(
                    getText(name: 'toastExchangeSuccessful'),
                    style: TextStyle(
              ...
              new Container(
                  ...
                  child: Text(
                    getText(name: 'textLookOnExchangeHistory'),
                    style: TextStyle(
