...
Widget buildView(
    PropDealHeadState state, Dispatch dispatch, ViewService viewService) {
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: MaterialButton(
                      onPressed: () {
                        dispatch(PropDealHeadActionCreator.gotoLogin());
                      },
                      height: 33,
                      minWidth: 67,
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      dispatch(PropDealHeadActionCreator.gotoMySellPage(1));
                    },
                    child: Container(
                        ...
                        children: <Widget>[
                          Text(
                            state.dealIndexData != null
                                ? state.dealIndexData.data.sellCnt.toString()
                                : "0",
                            style: TextStyle(
                                fontSize: 22, color: AppTheme.colors.textColor),
                          ),
                          Text(
                            getText(name: 'textSale'),
                            style: TextStyle(
                                fontSize: 10,
                                color: AppTheme.colors.textSubColor),
                          )
                  ...
                  GestureDetector(
                    behavior: HitTestBehavior.translucent,
                    onTap: () {
                      dispatch(PropDealHeadActionCreator.gotoMyBuyPage());
                    },
                    child: Container(
                      margin: EdgeInsets.only(left: 29),
                      child: Column(
