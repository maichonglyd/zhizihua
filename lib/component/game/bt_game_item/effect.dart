...
Effect<BTGameItemState> buildEffect() {
  return combineEffects(<Object, Effect<BTGameItemState>>{
...
void _gotoGameDetails(Action action, Context<BTGameItemState> ctx) {
...
void _onAction(Action action, Context<BTGameItemState> ctx) {
  AppUtil.gotoGameDetailOrH5Game(ctx.context, ctx.state.game);
}

void _deleteGame(Action action, Context<BTGameItemState> ctx) {
  if (Platform.isIOS) {
