...
class NewGameFragmentState implements Cloneable<NewGameFragmentState> {
  ...
  @override
  NewGameFragmentState clone() {
    return NewGameFragmentState()
      ..scrollController = scrollController
...
NewGameFragmentState initState(String videoType) {
  return NewGameFragmentState()
    ..videoType = videoType
